...
public class LegacyMetaServerProvider implements MetaServerProvider {
  ...
  private void initialize() {
    ...
    domains.put(Env.ZHUZHU, getMetaServerAddress(prop, "zhuzhu_meta", "zhuzhu.meta"));
    domains.put(Env.CZ, getMetaServerAddress(prop, "cz_meta", "cz.meta"));
    domains.put(Env.ALPHA, getMetaServerAddress(prop, "alpha_meta", "alpha.meta"));
    domains.put(Env.BETA, getMetaServerAddress(prop, "beta_meta", "beta.meta"));
    domains.put(Env.RC, getMetaServerAddress(prop, "rc_meta", "rc.meta"));
    domains.put(Env.GA, getMetaServerAddress(prop, "ga_meta", "ga.meta"));
    domains.put(Env.TEST, getMetaServerAddress(prop, "test_meta", "test.meta"));
    domains.put(Env.POC, getMetaServerAddress(prop, "poc_meta", "poc.meta"));
    ...
    domains.put(Env.PET, getMetaServerAddress(prop, "pet_meta", "pet.meta"));
  }
